...
class LazyPipelineExpr:
    ...
    def apply_mask(
        self, mask: "LazyPipelineExpr", *, invert: bool = ...
    ) -> "LazyPipelineExpr": ...
    def label_reduce(
        self, *, contours: pl.Expr, reduction: str = ..., region_mode: str = ...
    ) -> "LazyPipelineExpr": ...
    ...
    def apply_contour_mask(
        self, contour: "LazyPipelineExpr", *, invert: bool = ...
    ) -> "LazyPipelineExpr": ...
    ...
    def area(self, *, signed: bool = ...) -> LazyPipelineExpr: ...
    def assert_shape(
        self,
        *,
    ...
    def complex_conj(self) -> LazyPipelineExpr: ...
    def complex_magnitude(self) -> LazyPipelineExpr: ...
    def complex_phase(self) -> LazyPipelineExpr: ...
    def complex_power(self) -> LazyPipelineExpr: ...
    ...
    def dct2(self) -> LazyPipelineExpr: ...
    def dilate(
    ...
    def extract_contours(
        self, *, mode: str = ..., method: str = ..., min_area: float | None = ...
    ) -> LazyPipelineExpr: ...
    def extract_shape(self) -> LazyPipelineExpr: ...
    def fft2(self) -> LazyPipelineExpr: ...
    def fftshift(self) -> LazyPipelineExpr: ...
    ...
    def idct2(self) -> LazyPipelineExpr: ...
    def ifft2(self) -> LazyPipelineExpr: ...
    def ifftshift(self) -> LazyPipelineExpr: ...
    def invert(self) -> LazyPipelineExpr: ...
    def laplacian(self, *, ksize: int = ...) -> LazyPipelineExpr: ...
    def letterbox(
        self, *, height: IntOrExpr, width: IntOrExpr, value: FloatOrExpr = ...
    ) -> LazyPipelineExpr: ...
    ...
    def resize(
        self, *, height: IntOrExpr, width: IntOrExpr, filter: str = ...
    ) -> LazyPipelineExpr: ...
    def resize_max(
        self, max_size: IntOrExpr, *, filter: str = ...
    ) -> LazyPipelineExpr: ...
    def resize_min(
        self, min_size: IntOrExpr, *, filter: str = ...
    ) -> LazyPipelineExpr: ...
    def resize_scale(
        self,
        *,
    ...
    def resize_to_height(
        self, height: IntOrExpr, *, filter: str = ...
    ) -> LazyPipelineExpr: ...
    def resize_to_width(
        self, width: IntOrExpr, *, filter: str = ...
    ) -> LazyPipelineExpr: ...
    def roll(self, *, shifts: list[int], axes: list[int]) -> LazyPipelineExpr: ...
    def rotate(
        self,
        angle: FloatOrExpr,
        *,
    ...
    def sharpen(self, *, strength: float = ...) -> LazyPipelineExpr: ...
    def shear(
        self,
        *,
        sx: float = ...,
