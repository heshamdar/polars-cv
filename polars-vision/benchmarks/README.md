...
|-----------|-------------|
| `polars-vision-eager` | polars-vision with standard `.collect()` |
| `polars-vision-streaming` | polars-vision with `.collect(engine="streaming")` |
...
# Compare polars-vision modes
uv run python -m benchmarks.run_benchmarks --frameworks polars-vision-eager,polars-vision-streaming
```
...
|-----------------------------|--------------------|-------------------|--------------|
| polars-vision (streaming)   |            15,230  |              0.07 |        128.5 |
| polars-vision (eager)       |            12,450  |              0.08 |        245.3 |
