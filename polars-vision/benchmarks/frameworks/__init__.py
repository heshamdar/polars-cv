...
across different frameworks (polars-vision, OpenCV, PIL, torchvision).
"""
...
from .polars_vision_adapter import (
    PolarsVisionAdapter,
...
def get_adapter(name: str) -> BaseFrameworkAdapter:
    ...
    Args:
        name: Adapter name (e.g., "opencv", "polars-vision-eager").
    ...
    adapters: dict[str, type[BaseFrameworkAdapter]] = {
        ...
        "polars-vision-eager": PolarsVisionEagerAdapter,
        "polars-vision-streaming": PolarsVisionStreamingAdapter,
