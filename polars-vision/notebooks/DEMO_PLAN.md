# polars-vision Comprehensive Demo Notebook
...
### 1. Setup & Imports
- Import polars-vision and dependencies
...
2. **NumPy sink includes metadata header** (Helper added)
   ...
   - **Fixed**: Use `numpy_from_bytes()` helper from `polars_vision` to convert output to numpy array
