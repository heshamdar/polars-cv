...
polars-vision supports **multi-domain pipelines** that seamlessly transition between different data types.
...
```python
from polars_vision import CONTOUR_SCHEMA, POINT_SCHEMA
...
polars-vision performs **static type inference** at Polars planning time:
