...
polars-vision supports two execution modes: **eager** and **lazy**. Understanding when to use each is key to getting the most out of the library.
...
When using lazy mode with multi-output, polars-vision automatically optimizes shared operations:
