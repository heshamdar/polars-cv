...
polars-vision supports reading images directly from cloud storage providers.
...
By default, polars-vision uses the standard credential chain:
...
```python
from polars_vision import Pipeline, CloudOptions
