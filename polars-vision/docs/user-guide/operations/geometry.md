...
polars-vision provides comprehensive geometry operations through the `.contour` namespace.
...
```python
from polars_vision import CONTOUR_SCHEMA, POINT_SCHEMA, BBOX_SCHEMA
...
```python
from polars_vision import mask_iou, mask_dice, Pipeline
