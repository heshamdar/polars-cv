...
```python
from polars_vision import CONTOUR_SCHEMA
...
```python
from polars_vision import POINT_SCHEMA
...
```python
from polars_vision import BBOX_SCHEMA
...
::: polars_vision.geometry.contours.ContourNamespace
    options:
