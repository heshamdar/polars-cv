...
polars-vision is a Polars plugin that enables lazy, zero-copy image processing on DataFrame columns, powered by a Rust backend.
...
| Feature | polars-vision | Traditional Approach |
|---------|---------------|---------------------|
